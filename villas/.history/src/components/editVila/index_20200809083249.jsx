        ...
        <div>
            ...
            <form onSubmit={editHandler}>
                ...
                <div>
                    ...
                    <input type="number" name='beds' onChange={(e) => setBeds(e.target.value)} />
                </div>
                <div>
                    <label htmlFor="nights">number of nights : </label>
                    <input type="number" name='nights' onChange={(e) => setNights(e.target.value)} />
                </div>
                <div>
                ...
                <div>
                    ...
                    <input type="text" name='priceDescription' onChange={(e) => setPriceDescription(e.target.value)} />
                </div>
                <div>
                ...
                <div>
                    ...
                    <input type="text" name='imageUrl2'  onChange={(e) => setImageUrl2(e.target.value)} />
                </div>
                <div>
                    <label htmlFor="imageUrl3"> image 3  : </label>
                    <input type="text" name='imageUrl3'  onChange={(e) => setImageUrl3(e.target.value)} />
                </div>
                {!!msg && <div>{msg}</div>}
                <div>
