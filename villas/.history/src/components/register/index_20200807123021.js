        ...
        <div className={styles.Register}>
            ...
            <form onSubmit={buttonHandler}>
                ...
                <div className={styles['form-control']}>
                    ...
                    <input type="text" id="name" value={name} onChange={changeHandler} placeholder="Please enter name" />
                </div>
                <div className={styles['form-control']}>
                    <label htmlFor="password">Password</label>
                    <input type="password" id="password" value={password} onChange={changeHandler} placeholder="Please enter password" />
                </div>
                <div className={styles['form-control']}>
                    <label>Re-password</label>
                    <input type="password" id="repass" value={repass} onChange={changeHandler} placeholder="Please retype password" />
                </div>
                <div className={styles['form-control']}>
