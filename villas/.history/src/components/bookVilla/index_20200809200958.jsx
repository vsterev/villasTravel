...
const BookVilla = () => {
    ...
    return (
        <div>
            ...
            <div><input type="checkbox" checked={isAgree} onChange={() => setIsAgree(!isAgree)} id="checkbox" name="checkbox" /><label htmlFor="checkbox">Please confirm price and cancelation policy</label></div>
