...
const BookVilla = () => {
    ...
    const renderNames=()=>{
      return  beds.map((client, ind) => {
            <div key={ind}><input type="text" value={client}/></div>
        })
    }
    return (
        <div>
            ...
            <div><label><input type="checkbox" checked={isAgree} onChange={()=>setIsAgree(!isAgree)}/>Are you agree</label><br/></div>
