...
const BookVilla = () => {
    ...
    return (
        <div>
            ...
            <div> {renderNames()}</div>
            <div><label htmlFor="checkbox"><input type="checkbox" checked={isAgree} onChange={() => setIsAgree(!isAgree)} id="checkbox" name="checkbox"/>Please confirm price and cancelation policy</label><br /></div>
