...
const BookVilla = () => {
    ...
    return (
        <div>
            ...
            <div><label> please confirm cancelation policy and price<input type="checkbox" checked={isAgree} onChange={() => setIsAgree(!isAgree)} id="checkbox" name="checkbox" /></label></div>
