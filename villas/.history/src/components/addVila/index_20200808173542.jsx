...
const AddVilla = () => {
    ...
    const submitHandler = (e) => {
        e.preventDefault()
        console.log('name', name, 'region', region, 'date',date, 'beds', beds, 'nights', nights, 'price', price, 'priceDescription', priceDesription, 'description', description,
        ...
        <div>
            ...
            <form onSubmit={submitHandler}>
                ...
                <div>
                    ...
                    <input type="number" name='imageUrl' value={imageUrl} onChange={(e) => setImageUrl(e.target.value)} />
                </div>
                <div>
                    <label htmlFor="imageUrl2"> image 2  : </label>
                    <input type="number" name='imageUrl2' value={imageUrl2} onChange={(e) => setImageUrl2(e.target.value)} />
                </div>
                <div>
                    <label htmlFor="imageUrl3"> image 3  : </label>
                    <input type="number" name='imageUrl3' value={imageUrl3} onChange={(e) => setImageUrl3(e.target.value)} />
                </div>
                <div>
